...
<div ng-app="watchapp" ng-controller="watchController" ng-init="getwatches()">
<div class="main">
			<div class="container">
...
<div class="container">
<div class="row">
<div ng-repeat="watch in watches | filter:searchCondition">
...
<c:url value="resources/images/watches/{{watch.watchid}}.jpg" var="src" />
       ...
       <h3>Price:Rs.{{watch.price}}</h3>
        <c:url value="/ViewWatch{{watch.w_s_id}}" var="view" />
           ...
           <button type="button" class="btn btn-primar" data-toggle="modal" data-target="#myModal{{watch.watchid}}">Quick View</button>
                 
		<security:authorize access="hasRole('ROLE_ADMIN')">
		
		<a href="editwatch{{watch.watchid}}" class="btn btn-primar"><span class="glyphicon glyphicon-edit"></span></a></p>
		</security:authorize>
