...
<div class="container-wrapper">
    <div class="container">
        ...
        <button class="btn btn-primar" name="_eventId_backToCollectCustomerInfo">Back</button>

        <input type="submit" value="Next" class="btn btn-primar" name="_eventId_shippingDetailCollected" />
