                ...
                <form:form commandName="order" class="form-horizontal">
                    ...
                    <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                       ...
                       <div class="txt-center">
                        ...
                        <div class="row">
                            <table class="table table-hover">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItems}">
                                    <tr>
                                        <td class="col-md-9"><em>${cartItem.watch.watchName}</em></td>
                        ...
                        <button class="btn btn-primar" name="_eventId_backToCollectShippingDetail">Back</button>

                        <input type="submit" value="Submit Order" class="btn btn-primar" name="_eventId_orderConfirmed" />

                        <button class="btn btn-primar" name="_eventId_cancel">Cancel</button>
                    </div>
                </form:form>
            </div>
        </div>
